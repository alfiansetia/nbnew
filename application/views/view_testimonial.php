                        ...
                        <div class="testimonial-item-testi">
                            <img-comparison-slider hover="hover">
                                <figure slot="first" class="before">
                                    <img slot="first" width="100%" src="<?= base_url() . 'public/uploads/' . $value['photo'] ?>">
                                    <figcaption>Before</figcaption>
                                </figure>
                                <figure slot="second" class="after">
                                    <img slot="second" width="100%" src="<?= base_url() . 'public/uploads/' . $value['photo_1'] ?>">
                                    <figcaption>After</figcaption>
                                </figure>
                            </img-comparison-slider>
                        </div>
                        <div class="card-body ml-5">
                            <img src="<?= base_url() ?>public/svg/testi-icon.svg" style="width: 80px" alt="Arrow">
                            <h4 style="font-weight: 700"><?= $value['designation'] ?></h4>
                            <p><?= $value['comment'] ?></p>
                            <span style="font-weight:bold"><?= $value['name'] ?></span>
                            <div class="d-flex">
                                <?php for ($i = 0; $i < 4; $i++) : ?>
                                    <img src="<?= base_url() ?>public/svg/star.svg" style="width: 20px" alt="Arrow">
                                <?php endfor; ?>
                            </div>
                        </div>
                    </div>
