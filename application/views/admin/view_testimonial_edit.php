			...
			<div class="box box-info">
				<div class="box-body">
					...
					<div class="form-group">
						<label for="" class="col-sm-2 control-label">Existing Photo</label>
						<div class="col-sm-9" style="padding-top:5px">
							<img src="<?php echo base_url(); ?>public/uploads/<?php echo $testimonial['photo_1']; ?>" alt="Slider Photo" style="width:180px;">
						</div>
					</div>
					<div class="form-group">
						<label for="" class="col-sm-2 control-label">Photo 2</label>
						<div class="col-sm-6" style="padding-top:5px">
							<input type="file" name="photo_1">(Only jpg, jpeg, gif, and png are allowed)
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<select name="lang_id" class="form-control select2">
								...
								?><option value="<?php echo $row['lang_id']; ?>" <?php if ($testimonial['lang_id'] == $row['lang_id']) {
																						echo 'selected';
