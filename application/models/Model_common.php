...
class Model_common extends CI_Model
{
    ...
    public function all_page_choose()
    {
        $query = $this->db->query("SELECT * from tbl_why_choose WHERE lang_id=?", [$_SESSION['sess_lang_id']]);
    ...
    {
        $query = $this->db->query("SELECT * from tbl_feature WHERE lang_id=?", [$_SESSION['sess_lang_id']]);
        return $query->result_array();
    }
    ...
    {
        $query = $this->db->query("SELECT * FROM tbl_slider WHERE lang_id=?", [$_SESSION['sess_lang_id']]);
        return $query->result_array();
    }

    public function all_news_by_category($id)
    {
        $query = $this->db->query("SELECT * FROM tbl_news WHERE category_id=$id ORDER BY news_id DESC", [$_SESSION['sess_lang_id']]);
        return $query->result_array();
    }
    ...
    public function all_texture()
    {
        $query = $this->db->query("SELECT * from texture");
        return $query->result_array();
    }
    public function all_age()
    {
        $query = $this->db->query("SELECT * from age");
        return $query->result_array();
    }
    public function all_specific()
    {
        $query = $this->db->query("SELECT * from specific_needs");
        return $query->result_array();
    }
}
