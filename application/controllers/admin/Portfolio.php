...
class Portfolio extends CI_Controller
{
	...
	public function add()
	{
		...
		$data['ages'] = $this->Model_portfolio->get_all_age();
		$data['product_types'] = $this->Model_portfolio->get_all_product_type();
		$data['specific_needs'] = $this->Model_portfolio->get_all_specific_needs();
		$data['textures'] = $this->Model_portfolio->get_all_texture();
		...
		if (isset($_POST['form1'])) {
			...
			if ($valid == 1) {
				...
				$form_data = array(
					...
					'specific_need_id' 	=> $_POST['specific_need_id'],
					'type' 				=> $_POST['type'],
					'life_stage' 		=> $_POST['life_stage'],
					'size' 				=> $_POST['size'],
					'fungsi_utama' 		=> $_POST['fungsi_utama'],
					'komposisi' 		=> $_POST['komposisi'],
					'analisa_gizi' 		=> $_POST['analisa_gizi'],
					'kalori' 			=> $_POST['kalori'],
				);
