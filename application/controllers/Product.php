...
class Product extends MY_Controller
{
	...
	public function index()
	{
		...
		// $data['atrributes'] = $this->Model_portfolio->get_atrribute_data();

		$data['product_type'] = $this->Model_common->all_type();
		$data['texture'] = $this->Model_common->all_texture();
		$data['ages'] = $this->Model_common->all_age();
		$data['specific'] = $this->Model_common->all_specific();
		...
		if ($filter !== null && !empty($filter)) {
			...
			$data['portfolio'] = $this->Model_portfolio->get_portfolio_data_specific($kunci . '_id', $val);
			$data['filter'] = array(
				'filter' => $filter
			);
		} else {
	...
	public function view($id)
	{
		...
		$this->load->view('view_header', $data);
		$this->load->view('view_detail_product', $data);
		$this->load->view('view_footer');
	}
